...
def setup_logging(config: Optional[LogConfig] = None) -> 'Logger':
...
class Logger:
    ...
    def get_logger(self, name: str) -> logging.Logger:
        """Haal een logger op voor een specifieke module."""
    ...
    def set_level(self, level: int):
        """Verander het logging level voor alle loggers."""
    ...
    def add_file_handler(self, name: str, filename: str):
        """Voeg een file handler toe voor een specifieke logger."""
    ...
    def remove_file_handler(self, name: str, filename: str):
        """Verwijder een file handler van een specifieke logger."""
        if name in self._loggers:
